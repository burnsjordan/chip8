...
proc emulateCycle(chip8: var Chip8): int =
        ...
        of 0x2000:
                ...
                chip8.pc = chip8.opcode and 0x0FFF
        of 0x3000:
                if(chip8.V[(chip8.opcode and 0x0F00) shr 8] == uint8(chip8.opcode shr 16)):
                        chip8.pc += 2
                chip8.pc += 2
        of 0x4000:
                if(chip8.V[(chip8.opcode and 0x0F00) shr 8] != uint8(chip8.opcode shr 16)):
                ...
                chip8.pc += 2
        of 0x6000:
                chip8.V[(chip8.opcode and 0x0F00) shr 8] = uint8(chip8.opcode shr 16)
                chip8.pc += 2
        of 0x7000:
                chip8.V[(chip8.opcode and 0x0F00) shr 8] += uint8(chip8.opcode shr 16)
                chip8.pc += 2
        ...
        of 0xC000:
                let r = rand(255)
                chip8.V[(chip8.opcode and 0x0F00) shr 8] = uint8(uint8(r) and uint8(chip8.opcode shr 16))
                chip8.pc += 2
        of 0xD000:
